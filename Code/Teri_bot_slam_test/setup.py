...
setup(
    ...
    entry_points={  # Define console script entry points for creating executable command-line tools
        'console_scripts': [
            ...
            'image_listener = Teri_bot.image_listener:main',
            'lidar_converter = Teri_bot.lidar_converter:main',  # 点云转换为2D激光扫描数据
            'map_initializer = Teri_bot.map_initializer:main',  # 地图初始化节点
        ],
    },
)
